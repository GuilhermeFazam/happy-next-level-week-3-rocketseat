...
import { Map, Marker, TileLayer, GeoJSONProps } from 'react-leaflet';
...
const CreateOrphanage: React.FC = () => {
    ...
    function handleMapClick(event: LeafletMouseEvent): any {
            ...
            <main>
                <form className="create-orphanage-form" onSubmit={handleSubmit}>
                    <fieldset>
                        ...
                        <Map
                            center={[
                                positionDefault.latitude,
                                positionDefault.longitude,
                            ]}
